...
public class HorasSuplementarias {
    public static void main(String[] args) {
        ...
        ValorHoraOrdinaria = truncateDecimal(ValorHoraOrdinaria, 2);
        ...
        ValorPorHoraExtra = truncateDecimal(ValorPorHoraExtra, 2);
        ...
        ValorTotalHorasExtras = truncateDecimal(ValorTotalHorasExtras, 2);
